 ...
 */
public abstract class BallNetworkTableWriter extends NetworkTableWriter
{
     ...
     */
    public BallNetworkTableWriter(BallPipelineInterpreter interpreter, NetworkTable publishingTable) {
